...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header" styles="background-color:#09f">
    <div class="topbar">
        ...
        <div style="float: right; height: 90px;display:table;margin-top: 20px;margin-right: 13%;">
            <button class="standard-button" onclick="location.href='register'">Register</button>
            <button class="signout-button" onclick="location.href='connection'">Sign In</button>
        </div>
    </div>
    <br><br><br>
    <div class="content">
        <span class="titles-cards">Linking everything is now possible</span>
    </div>
</div>
